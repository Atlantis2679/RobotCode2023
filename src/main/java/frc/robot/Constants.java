...
public final class Constants {
    ...
    public static final class Autos {
        public static final class FreeArmConstants {
        ...
        public static final class ReleaseCubeConstants {
            public static final double RELEASE_SPEED = 0.4;
            public static final double RELEASE_TIME_SECONDS = 0.5;
        }

        public static final class releaseCubeSecondConstants {
        ...
        public static final class releaseCubeThirdConstants {
            public static final double TIMEOUT_SECONDS_RAISE = 6;
            public static final double TIMEOUT_SECONDS_LOWER = 6;
        }

        public static final class ReleaseConeConstants {
            public static final double RELEASE_SPEED = 0.4;
            public static final double RELEASE_TIME_SECONDS = 1;
        }

        public static final class releaseConeThirdConstants {
            public static final double TIMEOUT_SECONDS_RAISE = 6;
            public static final double TIMEOUT_SECONDS_LOWER = 6;
        ...
        public static final class releaseConeSecondConstants {
            public static final double TIMEOUT_SECONDS_RAISE = 6;
            public static final double TIMEOUT_SECONDS_LOWER = 6;
        }

        public static final class DriveBackwardsOutsideCommunityConstants {
        ...
        public static final class GetOnChargeStationConstants {
